...
describe "Flight" do
  ...
  subject {Flight.new(1 ,"default", "departure" ,"arrival",10,100,20,100,500, 200,"5",Time.now, Time.now,10,100,20)}
  ...
  it "should first class seats availability greater than zero" do
    subject.search_available_seats("first",4).should == true
  end
