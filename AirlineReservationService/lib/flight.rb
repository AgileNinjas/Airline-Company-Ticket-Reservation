...
attr_accessor :max_economic_counter, :max_business_counter , :max_first_class_counter
# def initialize  (id=1 , name="default" , capacity=120 , departure = "departure" , arrival= "arrival", first_class_capacity = 20,economic_class_capacity = 100,business_class_capacity = 0,economic_class_price = 100,first_class_price = 500,business_class_price = 200)
   ...
   @available_seats_first_class = first_class_capacity
    ...
    @max_first_class_counter = first_class_price
    ...
    if kind_of_seat == "economic"
        ...
        if number_of_seats < @max_business_counter
          ...
          false
           ...
           if number_of_seats < @max_first_class_counter
             @max_first_class_counter = @max_first_class_counter - number_of_seats
             true
           else
             false
           end
  ...
  def update_available_seats reservation
    if reservation.class_type == "economic"
          ...
          @max_first_class_counter = @max_first_class_counter - 1
    end
  end
